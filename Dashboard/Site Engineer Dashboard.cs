...
{
    public partial class Site_Engineer_Dashboard : Form
    {
        public Site_Engineer_Dashboard()
        {
            InitializeComponent();
            GetOpenSession();
            Home_Site_Enginer uc = new Home_Site_Enginer();
            addUsercontrols(uc);
        ...
        private void addUsercontrols(UserControl userControl)
        {
            ...
            SiteEnginerDashPanel.Controls.Clear();
            SiteEnginerDashPanel.Controls.Add(userControl);
        ...
        {
            Project_user_control us= new Project_user_control();
            addUsercontrols(us);
        }
