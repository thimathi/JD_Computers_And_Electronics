...
{
    public partial class Accountant_Dashboard : Form
    {
        public Accountant_Dashboard()
        {
            InitializeComponent();
            Home_Accountant uc = new Home_Accountant();
            GetOpenSession();
            addUsercontrols(uc);
        ...
        private void addUsercontrols(UserControl userControl)
        {
            ...
            AccountantDashPanel.Controls.Clear();
            AccountantDashPanel.Controls.Add(userControl);
        ...
        {
            Pay_Sheet_User_Control uc =new Pay_Sheet_User_Control();
            addUsercontrols(uc);
        }
